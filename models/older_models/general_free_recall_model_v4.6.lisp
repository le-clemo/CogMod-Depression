...
;;; Free Recall - General Model V4.6 [controls]
...
(sgp 
   ...
   :lf 3 ; latency-factor (default = 1, Anderson model = 2)
...
(spp skip-rehearse-1 :u 1)
(spp skip-rehearse-2 :u 1)
(spp skip-rehearse-3 :u 1)
(spp skip-rehearse-4 :u 1)

(spp forget-word-1 :u 0.85)
(spp forget-word-2 :u 0.85)
(spp forget-word-3 :u 0.85)
(spp forget-word-4 :u 0.85)
